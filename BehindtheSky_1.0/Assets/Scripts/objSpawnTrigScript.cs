	...
	void Update () {
		...
		if (triggerMethod == true) 
		{
			if (camMovSc.score <= 1000)
			{
				...
				objSpawnChanceRange = Random.Range (1, 4);
		...
		if (trigForResources == true) 
		{
			...
			} else if (objSpawnChanceRange > 30 && objSpawnChanceRange <= 60)
			{
				...
				trigForResources = false;
			} else if (objSpawnChanceRange > 60 && objSpawnChanceRange <= 63)
			{
				...
				trigForResources = false;
			} else if (objSpawnChanceRange > 63 && objSpawnChanceRange <= 70)
			{
